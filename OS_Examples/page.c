...
/*
pte_status is the status of a page table entry. It can be allocated,
lazy, or shared.
*/
typedef enum pte_status {ALLOCATED, LAZY, SHARED} pte_status;

/*
This is the entry of a page table. It has a frame number, a status
and also a pointer to a copy of itself.
*/
...
/*
This array is the page table object, it has a variable for how many
pages, and the pointer to all the page table entries.
*/
...
void jonthesbigbench(){
  array *jonthe = create(256);
  }
